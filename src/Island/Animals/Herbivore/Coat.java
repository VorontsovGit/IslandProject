...
public class Coat extends Herbivore{
    private static int maxQuantity = 107;
    ...
    public static int multiply(HashSet arrayList) {
        long count = arrayList.stream().filter(x -> x instanceof Coat).count();
        int returnedCount = 0;
